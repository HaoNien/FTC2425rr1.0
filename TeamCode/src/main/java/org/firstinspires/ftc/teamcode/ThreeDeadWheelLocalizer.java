...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -11360.0; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 12100; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =   9800; // x position of the perpendicular encoder (in tick units)
    }
